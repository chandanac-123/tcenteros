    ...
    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-[#FFFFFF] border border-[#E0DDD8] rounded-xl shadow-md p-4 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <p className="text-[#000000] text-2xl font-semibold">1.5 CR</p>
      ...
      <div className="bg-[#FFFFFF] border border-[#E0DDD8] rounded-xl shadow-md p-4 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <p className="text-[#000000] text-2xl font-semibold">16.33 CR</p>
      ...
      <div className="bg-[#FFFFFF] border border-[#E0DDD8] rounded-xl shadow-md p-4 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <p className="text-[#000000] text-2xl font-semibold">48 L</p>
      ...
      <div className="bg-[#FFFFFF] border border-[#E0DDD8] rounded-xl shadow-md p-4 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <p className="text-[#000000] text-2xl font-semibold">₹56,789</p>
