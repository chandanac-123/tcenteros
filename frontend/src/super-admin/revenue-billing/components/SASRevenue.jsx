...
const SASRevenue = () => {
  ...
  const percentage = doughnutData.map((item) => item.percentage);
    ...
    <div>
      ...
      <div className="p-4">
        <div className="w-full  flex items-stretch justify-betwwen gap-5 shadow-[0px_5px_15px_rgba(0,0,0,0.35)] rounded-lg p-8">
          ...
          <div className="w-[60%] p-5 rounded-lg flex items-center justify-center">
