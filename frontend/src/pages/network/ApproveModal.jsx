...
const ApproveModal = ({ open, setOpen, data }) => {
    ...
    const { mutateAsync: approveRequest, isPending } = useEditApproveNetworkMutation();
        ...
        <>
            ...
            >
                <form className='space-y-5'  onSubmit={handleApprove}>
                    ...
                    <p>Accepting this request will grant <span className='font-semibold'> {data.member_full_name}</span> temporary access to work out at this center. </p>
