...
const CenterDetails = () => {
  ...
  return (
    <ContentLayout>
      <div className=''>
        <div className=''>
          <h2 className='not-italic font-medium leading-[140%] text-[24px] tracking-[-0.24px]'>
            Center Details
          </h2>
          <CustomeBreadcrumb
            goBack={() => navigate('/network')}
            buttonName='Network Listing'
            currentPageName='Network detail view'
          />
            ...
            <div className='flex item  justify-between px-5 py-8 rounded-[19px] border '>
              ...
              <div className='flex flex-col  space-y-1'>
                ...
                <span className='text-sm font-normal leading-[137%]'>
                  {data?.home_center?.center_name || '_ _'}
                </span>
              </div>
              ...
              <div className='flex flex-col  space-y-1 '>
                ...
                <span className=' text-sm font-normal leading-[137%]'>
                  {data?.home_center.center_category || '_ _'}
                </span>
              </div>
              ...
              <div className='flex flex-col  space-y-1 '>
                ...
                <span className='text-sm font-normal leading-[137%]'>
                  {data?.home_center?.center_email || '_ _'}
                </span>
              </div>
              ...
              <div className='flex flex-col space-y-1'>
                ...
                <span className='text-sm font-normal leading-[137%]'>
                  {data?.home_center?.center_number || '_ _'}
                </span>
              </div>
            </div>
          </div>
              ...
              <div className='w-full  flex   gap-6 justify-between'>
                <div className='w-[40%] flex justify-between items-center'>
                  <div className='flex flex-col  space-y-1'>
                    ...
                    <span className='text-sm font-normal leading-[137%]'>
                      {data?.home_center?.address?.country || '_ _'}
                    </span>
                  </div>
                  ...
                  <div className='flex flex-col  space-y-1'>
                    ...
                    <span className='text-sm font-normal leading-[137%]'>
                      {data?.home_center?.address?.state || '_ _'}
                    </span>
                  </div>
                </div>
                <div className='w-[40%] flex justify-between items-center '>
                  <div className='flex flex-col  space-y-1'>
                    ...
                    <span className='text-sm font-normal leading-[137%]'>
                      {data?.home_center?.address?.city || '_ _'}
                    </span>
                  </div>
                  ...
                  <div className='flex flex-col  space-y-1'>
                    ...
                    <span className='text-sm font-normal leading-[137%]'>
                      {data?.home_center?.address?.postal_code || '_ _'}
                    </span>
                  </div>
                </div>
              </div>
              <div className='w-full flex   gap-6 justify-between'>
                <div className='w-[40%]'>
                  <div className='flex flex-col  space-y-1'>
                    ...
                    <span className='text-sm font-normal leading-[137%]'>
                      {data?.home_center?.address?.address_line_1 || '_ _'}
                    </span>
                  </div>
                </div>
                <div className='w-[40%]  '>
                  <div className='flex flex-col  space-y-1'>
                    ...
                    <span className='text-sm font-normal leading-[137%]'>
                      {data?.home_center?.address?.address_line_2 || '_ _'}
                    </span>
                  </div>
                </div>
              </div>
